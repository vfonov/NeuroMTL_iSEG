-------------------------------- MNI Header -----------------------------------
-- @NAME       :  cnn_random_fcn_ace_iseg.lua
-- @DESCRIPTION:  Pretraining using ACE-IBIS data
-- @COPYRIGHT  :
...
local training_list="ace_i_list.lst"
...
local output_template='iseg_train/v2_s0_%d_fold_'
local pretrain_model_template='iseg_train/v2_s0_1_fold_training.t7'  -- previous checkpoint
...
local program={
    { 
      batches=10000, iter=2, LR=0.0001 ,LRd=0.0001, beta1=0.9, beta2=0.999, eps=1e-8, samples=3, validate=20, optim=optim.adam, rehash=200, regenerate=400,
