-------------------------------- MNI Header -----------------------------------
-- @NAME       :  cnn_random_fcn_ace_iseg_s2.lua
-- @DESCRIPTION:  iSEG cross-validation experiment (stage 2 after ACE-IBIS pre-training)
-- @COPYRIGHT  :
...
local output_template='iseg_train/v2_s3_%d_fold_'
